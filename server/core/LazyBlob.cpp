...
Blob& operator += (Blob& a, const LazyBlob& b) {
    ...
    size_t dims[] = {a.shape.dim4(), a.shape.dim3(), a.shape.rows(), a.shape.cols()};
...
//    std::vector<size_t> sizev = a.shape.getDims();
//    size_t size[] = {sizev[0], sizev[1], sizev[2], sizev[3]};
